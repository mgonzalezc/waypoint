...
class RankingResponseDto {
  const RankingResponseDto({required this.items});
  ...
  factory RankingResponseDto.fromJson(Map<String, dynamic> json) {
    ...
    return RankingResponseDto(items: items);
  }

  static RankingItem _itemFromJson(Map<String, dynamic> json, {required int position}) {
  ...
  static List<SourceCitation> _sourcesFromJson(Object? rawSources) {
